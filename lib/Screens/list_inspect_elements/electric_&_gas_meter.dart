...
class ListInspectionElmentsElectricOrGasMeter extends StatefulWidget {
  const ListInspectionElmentsElectricOrGasMeter({Key? key}) : super(key: key);

  @override
  State<ListInspectionElmentsElectricOrGasMeter> createState() =>
      _ListInspectionElmentsElectricOrGasMeterState();
}

class _ListInspectionElmentsElectricOrGasMeterState
    extends State<ListInspectionElmentsElectricOrGasMeter> {
